        ...
        <v-app id="inspire">
          ...
          >
            <template v-slot:top>
              ...
              <v-col cols="6" sm="6" md="6" align-center justify-center>
                <v-text-field
                  v-model="search"
                  append-icon="search"
                  label="Búsqueda"
              ...
              <v-dialog v-model="dialogDelete" max-width="500px">
                <v-card>
                  <v-card-title class="text-h5"
                    >¿Está seguro de borrar el Cliente?</v-card-title
                  >
                  <v-card-actions>
                    <v-spacer></v-spacer>
...
export default {
  data() {
    return {
      personas: [], // almacenará las usuarios
      search: "",
      dialog: false,
      dialogDelete: false,
      headers: [
  ...
  methods: {
      ...
      if (this.editedIndex > -1) {
        ...
        axios
          ...
          .then(function (response) {
            ...
            me.listar();
            me.alerta_edit = true;
            me.mensaje = "Persona editada correctamente";
          })
          .catch(function (error) {
            console.log(error);
          });
    ...
    editItem(item) {
      ...
      this.dialog = true;
      this.editedIndex = 1;
      this.mensaje = "Persona modificado correctamente";
    },
    ...
    desactivar() {
      ...
      axios
        ...
        .then(function (response) {
          ...
          me.listar();
          me.alerta_edit = true;
          me.mensaje = "persona desactivado";
        })
        .catch(function (error) {
          console.log(error);
        });
